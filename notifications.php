...
$notifications = [
    ['message' => 'Payment due: July 20, 2025', 'date' => '2025-07-18'],
    ['message' => 'You updated your profile photo.', 'date' => '2025-07-17'],
    ['message' => 'New announcement posted.', 'date' => '2025-07-15'],
];
?>
...
<head>
  <meta charset="UTF-8" />
  <title>Notifications | Aqua-Bill</title>
  ...
  <div class="container">
    ...
    <?php foreach ($notifications as $note): ?>
      <div class="notification">
        <div class="text"><?= htmlspecialchars($note['message']) ?></div>
        <small><?= date('F j, Y', strtotime($note['date'])) ?></small>
      </div>
    <?php endforeach; ?>
  </div>
</div>
